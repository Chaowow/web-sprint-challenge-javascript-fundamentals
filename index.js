...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//The nested function can access the varaible because it is a closure and functions can access varaibles from outside their scope but not within another scope.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(animal => {
      ...
      let sciName = animal.scientific_name;
      newArray.push(`name: ${name}, scientific: ${sciName}`)
    });
    return newArray;
  }
  ...
  */
  ...
  function USApop(array){
    const totalPopulation = array.reduce((acc, currentValue) => {
